...
// CUT begin
	public static void main(String[] args){
		System.err.println("Deadfish (1000 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1555774899;
	...
	static boolean doTest(int N, int __expected) {
		...
		int __result = 0;
		try {
			__result = instance.shortestCode(N);
		}
	...
	static class Reader {
        private static final String dataFileName = "Deadfish.sample";
