...
// CUT begin
	public static void main(String[] args){
		System.err.println("CalcTest (250 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
	    ...
	    while (true) {
            ...
            String[] numbers = new String[Integer.parseInt(Reader.nextLine())];
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1556189634;
        double PT = T / 60.0, TT = 75.0;
        System.err.println(String.format("Time   : %d minutes %d secs%nScore  : %.2f points", T / 60, T % 60, 250 * (0.3 + (0.7 * TT * TT) / (10.0 * PT * PT + TT * TT))));
	}

	static boolean doTest(String[] numbers, String[] __expected) {
		for (int i = 0; i < numbers.length; i++) {
			numbers[i] = new String(numbers[i]);
		}
		...
		try {
			__result = instance.uniform(numbers);
		}
	...
	static class Reader {
        private static final String dataFileName = "CalcTest.sample";
