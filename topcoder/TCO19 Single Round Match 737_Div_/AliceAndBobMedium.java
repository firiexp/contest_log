...
// CUT begin
	public static void main(String[] args){
		System.err.println("AliceAndBobMedium (500 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1537355720;
	...
	static boolean doTest(int[] a, int __expected) {
		...
		AliceAndBobMedium instance = new AliceAndBobMedium();
		int __result = 0;
		try {
	...
	static class Reader {
        private static final String dataFileName = "AliceAndBobMedium.sample";
