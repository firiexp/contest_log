...
// CUT begin
	public static void main(String[] args){
		System.err.println("EllysAndXor (250 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1555775988;
	...
	static boolean doTest(int[] numbers, int __expected) {
		...
		int __result = 0;
		try {
			__result = instance.getMax(numbers);
		}
	...
	static class Reader {
        private static final String dataFileName = "EllysAndXor.sample";
