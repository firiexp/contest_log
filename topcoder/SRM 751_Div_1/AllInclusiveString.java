...
// CUT begin
	public static void main(String[] args){
		System.err.println("AllInclusiveString (1000 Points)");
		System.err.println();
	...
	static void runTest(HashSet<Integer> caseSet) {
        ...
        int T = (int)(System.currentTimeMillis() / 1000) - 1550808337;
	...
	static boolean doTest(String[] a, int[] __expected) {
		for (int i = 0; i < a.length; i++) {
			a[i] = new String(a[i]);
		}
		long startTime = System.currentTimeMillis();
		Throwable exception = null;
		AllInclusiveString instance = new AllInclusiveString();
		int[] __result = new int[0];
		try {
			__result = instance.shortest(a);
		}
	...
	static class Reader {
        private static final String dataFileName = "AllInclusiveString.sample";
