...
struct modint{
    ...
    modint(): val(0){}
    template<typename T>
    modint(T t){val = t%M; if(val < 0) val += M;}
...
int main() {
    ...
    cin >> n;
    mat A;
    A[1][0] = 1; A[1][1] = 100; A[2][1] = 1; A[2][2] = 1;
    ar x = {0, 1, 1};
    x *= A.pow(n);
    cout << x[0].val << "\n";
    vector<string> s = {"1", "101", "10101", "1010101", "101010101", "10101010101", "1010101010101",
                        "101010101010101", "10101010101010101", "1010101010101010101", "0"};
    cout << s[(n-1)%11] << "\n";
    return 0;
}